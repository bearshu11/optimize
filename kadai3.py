...
print("***(1)***")
print("***再急降下法***")
method = SteepestDecentMethod(f1,dif_f1,np.array(x0_1))
method.solve()
...
print("***共役勾配法***")
method = FletcherReeves(f1,dif_f1,np.array(x0_1))
method.solve()
x,a = method.getAnswer()
...
print("***準ニュートン法***")
method = BFGS(f1,dif_f1,np.array(x0_1))
method.solve()
x,a = method.getAnswer()
...
print("***(2)***")
print("***再急降下法***")
method = SteepestDecentMethod(f2,dif_f2,np.array(x0_1))
method.solve()
...
print("***共役勾配法***")
method = FletcherReeves(f2,dif_f2,np.array(x0_1))
method.solve()
x,a = method.getAnswer()
...
print("***準ニュートン法***")
method = BFGS(f2,dif_f2,np.array(x0_1))
method.solve()
x,a = method.getAnswer()
...
print("***(3)***")
print("***再急降下法***")
method = SteepestDecentMethod(f3,dif_f3,np.array(x0_2))
method.solve()
...
print("***共役勾配法***")
method = FletcherReeves(f3,dif_f3,np.array(x0_2))
method.solve()
x,a = method.getAnswer()
...
print("***準ニュートン法***")
method = BFGS(f3,dif_f3,np.array(x0_2))
method.solve()
x,a = method.getAnswer()
